  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="form">
        ...
        <label className="name">Ingredientes: </label>
...
{/*
        ...
        <button className="cvid" type="submit" disabled={!isFormValid}>Crear Receta</button>
